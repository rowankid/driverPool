...
public class PooledDriver {
	...
	private DriverInterceptor interceptor;
     ...
     * @return driver;
     */
	public PooledDriver initDriver(WebDriverCreater creater) {

		try {
			System.out.println("init a new driver " + this.getDriverName() + " at " + new Date());
			Thread.sleep(1000);
			System.out.println("finish to init a new driver " + this.getDriverName() + " at " + new Date());
	...
	public void discard() {
    	setDiscarded(true);
		if(this.driver == null) {
			System.out.println("driver " + this.getDriverName() + " has null driver, discard finish!");
		}
		else {
			this.driver.quit();
			System.out.println("driver " + this.getDriverName() + " quit driver, discard finished");
		}
	}
	...
	public DriverInterceptor getInterceptor() {
		return interceptor;
	}

	public void setInterceptor(DriverInterceptor interceptor) {
